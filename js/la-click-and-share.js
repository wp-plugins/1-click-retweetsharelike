...
$(document).ready(function()
{
	...
	$("#lacands_idPosColorsContentWidget").hide();
	$('#lacands_idPosColorsWidget').click( function() {
		$("#lacands_idPosColorsContentWidget").toggle( "fast", function() {
										myElementText = $("#lacands_idPosColorsWidget").text();
										if(myElementText == 'Edit') {
											$("#lacands_idPosColorsWidget").text("Hide");
										}
										else if (myElementText == 'Hide') {
											$("#lacands_idPosColorsWidget").text("Edit");
										}
									}				
							);			
	});
